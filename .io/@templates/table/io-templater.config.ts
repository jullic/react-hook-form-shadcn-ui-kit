...
export const Config: IConfig = {
	inputArgs: [
		{ name: 'IO_COMPONENT_NAME', message: 'Название таблицы', replace: true },
		{ name: 'IO_ENTITY_NAME', message: 'Название сущности', replace: true },
	],
	outputPathFromRoot: 'src/entities',
	additionalArgs: [
		{ name: 'IO_COMPONENT_NAME_KEBAB', replace: true, value: '__~~~IO_COMPONENT_NAME' },
		{ name: 'IO_ENTITY_NAME_KEBAB', replace: true, value: '__~~~IO_ENTITY_NAME' },
